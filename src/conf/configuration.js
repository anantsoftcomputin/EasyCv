var config = {
  adminEmail:"anantsoftcomputing@gmail.com",  // The website will consider this email  as an admin 
  brand: {
  ...
  meta:{
    title :"EasyCv Resume Builder V0.1.0, Build a Perfect Resume in 5min ",  // Your website title here
